...
async def test_forward_message(bot: Bot):
    ...
    from .dataset import FORWARDED_MESSAGE
...
async def test_send_photo(bot: Bot):
    ...
    from .dataset import MESSAGE_WITH_PHOTO, PHOTO
...
async def test_send_audio(bot: Bot):
    ...
    from .dataset import MESSAGE_WITH_AUDIO
...
async def test_send_document(bot: Bot):
    ...
    from .dataset import MESSAGE_WITH_DOCUMENT
...
async def test_send_video(bot: Bot):
    ...
    from .dataset import MESSAGE_WITH_VIDEO, VIDEO
...
async def test_send_voice(bot: Bot):
    ...
    from .dataset import MESSAGE_WITH_VOICE, VOICE
...
async def test_send_video_note(bot: Bot):
    ...
    from .dataset import MESSAGE_WITH_VIDEO_NOTE, VIDEO_NOTE
...
async def test_send_media_group(bot: Bot):
    ...
    from .dataset import MESSAGE_WITH_MEDIA_GROUP, PHOTO
...
async def test_send_location(bot: Bot):
    ...
    from .dataset import MESSAGE_WITH_LOCATION, LOCATION
...
async def test_stop_message_live_location_by_bot(bot: Bot):
    ...
    from .dataset import MESSAGE_WITH_LOCATION
    msg = types.Message(**MESSAGE_WITH_LOCATION)
...
async def test_send_venue(bot: Bot):
    ...
    from .dataset import MESSAGE_WITH_VENUE, VENUE, LOCATION
...
async def test_send_contact(bot: Bot):
    ...
    from .dataset import MESSAGE_WITH_CONTACT, CONTACT
...
async def test_send_dice(bot: Bot):
    ...
    from .dataset import MESSAGE_WITH_DICE
...
async def test_get_user_profile_photo(bot: Bot):
    ...
    from .dataset import USER_PROFILE_PHOTOS, USER
    user = types.User(**USER)
...
async def test_export_chat_invite_link(bot: Bot):
    ...
    from .dataset import CHAT, INVITE_LINK
    chat = types.Chat(**CHAT)
...
async def test_get_chat_member(bot: Bot):
    ...
    from .dataset import CHAT, CHAT_MEMBER
    chat = types.Chat(**CHAT)
...
async def test_set_my_commands(bot: Bot):
    ...
    from .dataset import BOT_COMMAND
...
async def test_edit_message_text_by_bot(bot: Bot):
    ...
    from .dataset import EDITED_MESSAGE
